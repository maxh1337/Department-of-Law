...
function Eight() {
    ...
    if (step !== 8) { localStorage.setItem("step", 8)}
    const CheckAndRedirect = () => {
        const inputValue = document.getElementById("inp1").value
        if (
            inputValue.toLowerCase() === 'понятые'
        ) {
            navigate("/9");
    ...
    return(
        ...
        <div>
            ...
            <div className="in-book" style={{ textAlign: "center", marginTop : "50px" }}>
        ...
        newButton={<a target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1O6yiHCOluYvXHOBbVOBF3B_bI-JN9ufb/view"> <button>Не понятно</button></a>}
