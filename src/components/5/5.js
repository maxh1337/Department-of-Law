...
function Five(){
    ...
    if (step !== 5) { localStorage.setItem("step", 5)}
    ...
    return(
        ...
        <div>
            ...
            <div className="doc-content">
                <div className="Buttons">
                    <a target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1pjE-OOjKm-Cj78MKxQJqr5UiEXChIxAF/view">
        ...
        <div className="doc-content">
            <div className="Buttons">
                <a target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1p5y9GCvhO-zizn7QQAFNkAJLZNZvGYZG/view">
        ...
        <div>
            ...
            <div className="doc-content">
                <div className="Buttons">
                    <a target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1vMlOar6blg4XyuUdUvM2UYXwNP--13F7/view">
                        <button>Открыть рапорт об обнаружении признаков преступления</button> 
                    </a>
                <br/>
                <br/>
        ...
        <div>
            ...
            <div className="doc-content">
                <div className="Buttons">
                    <a target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1f3E5XSKmwWhc25xdmgKMcrhdhn6ER_y1/view">
